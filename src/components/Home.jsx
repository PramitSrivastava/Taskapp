  ...
  return (
    <div>
     <div className="heading">
      <h1 >Workcheck brings all your tasks, teammates, and tools together</h1>
      <p><b>Keep everything in the same place—even if your team isn’t. </b></p>
      </div>
    <div class="cards">

<div class="card">
  <div class="card__image-holder">
    <img class="card__image" src="https://images.unsplash.com/photo-1573495612890-430e48b164df?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8YWNjZXNpYmxlfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60" alt="wave" />
  </div>
...
<div class="card">
  <div class="card__image-holder">
    <img class="card__image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSt6rcNTS_T4R8Le_cG7gEiktVBayGKpyxuUw&usqp=CAU" alt="beach" />
  </div>
  <div class="card-title">
    <a href="#" class="toggle-info btn">
      <span class="left"></span>
...
<div class="card">
  <div class="card__image-holder">
    <img class="card__image" src="https://images.unsplash.com/photo-1616531770192-6eaea74c2456?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8cmVtb3RlfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60" alt="mountain" />
  </div>
  <div class="card-title">
    <a href="#" class="toggle-info btn">
      <span class="left"></span>
...
<div class="card">
  <div class="card__image-holder">
    <img class="card__image" src="https://images.unsplash.com/photo-1543286386-713bdd548da4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8dHJhY2slMjBwcm9ncmVzc3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="field" />
  </div>
  <div class="card-title">
    <a href="#" class="toggle-info btn">
      <span class="left"></span>
    ...
    <h2>
        Track work across multiple team
        <small>Image from unsplash.com</small>
    </h2>
  </div>
  <div class="card-flap flap1">
...
<div class="card">
  <div class="card__image-holder">
    <img class="card__image" src="https://images.unsplash.com/photo-1580982324076-d95230549339?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGNvZGluZyUyMHRlYW18ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60" alt="water" />
  </div>
  <div class="card-title">
    <a href="#" class="toggle-info btn">
      <span class="left"></span>
...
<div class="card">
  <div class="card__image-holder">
    <img class="card__image" src="https://plus.unsplash.com/premium_photo-1661759050210-228782400c57?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8Y29kaW5nJTIwdGVhbXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="river" />
  </div>
  <div class="card-title">
    <a href="#" class="toggle-info btn">
      <span class="left"></span>
...
<div class="px-4 py-5 my-5 text-center">
  ...
  <h1 class="display-5 fw-bold">Work with excellence</h1>
  <div class="col-lg-6 mx-auto">
    <h3 class="lead mb-4">Simple, flexible, and powerful. All it takes are boards, lists, and cards to get a clear view of who’s doing what and what needs to get done. Learn more in our guide for getting started.Start each day without any surprises. Whether scheduling an editorial calendar or staying on top of to-dos, Calendar view is like a crystal ball giving you a clear vision of what work lies ahead.</h3>
...
<div class="b-example-divider"></div>
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      <div class="col-10 col-sm-8 col-lg-6">
      <h1 class="display-5 fw-bold lh-1 mb-3"> Get started </h1>
        <h3 class="lead"><b>Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident iusto, nisi suscipit alias nemo, esse quaerat eveniet voluptate commodi excepturi quasi assumenda explicabo voluptatum quo dolore! Neque molestias velit ducimus?</b></h3>
      </div>
      <div class="col-lg-6">
      <img src="https://images.ctfassets.net/rz1oowkt5gyp/5Hb09iiMrK6mSpThW5HS89/f5683a167ad3f74bed4dc7592ae5a002/TrelloBoard_Timeline_2x.png?w=1140&fm=webp" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy"/>
